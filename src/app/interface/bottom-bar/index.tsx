    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        <Button variant="outline">
          <span className="hidden md:inline"><a href="https://aicomicgenerator.net/" target="_blank" title="AI Comic Generator">Back Home</a></span>
          <span className="inline md:hidden"><a href="https://aicomicgenerator.net/" target="_blank" title="AI Comic Generator">Back</a></span>
        </Button>
       {/* 
